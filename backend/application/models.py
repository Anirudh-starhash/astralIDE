...
class Folders(db.Model):
    ...
    no_of_files=db.Column(db.Integer,default=0)
    folder_toggle=db.Column(db.Integer,default=0)
    parent_folder=db.Column(db.String(128),nullable=True)
    nesting=db.Column(db.Integer,default=0)
    no_of_folders=db.Column(db.Integer,default=0)
...
class File(db.Model):
    ...
    parent_folder=db.Column(db.String(128))
