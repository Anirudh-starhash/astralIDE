      ...
      <div class="editor-wrapper">
        <div class="menu-bar">
          ...
          <a @click="saveCode" class="menu-button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="aliceblue" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Icons" viewBox="0 0 32 32" xml:space="preserve">
          ...
          <span class="file-name white">File: {{ fileName }}</span>
        </div>
...
<style scoped>
  ...
  .editor-wrapper {
    ...
    background-color: #1e1e1e; /* Box background color */
    padding: 20px;
  ...
  .code-textarea {
    background-color: white; /* Textarea background color */
    color: blue; /* Text color inside textarea */
    font-weight: bold; /* Bold text */
